...
import { getEstadoPorteria, sortTransportesPorEstado } from '../../utils/porteria';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-[#0b0f19] rounded-2xl border border-zinc-800 overflow-hidden shadow-2xl">
        ...
        <div className="grid grid-cols-[10rem_7rem_6rem_5rem_1fr_5rem_6rem_5rem_9rem] gap-2 px-4 py-2.5 bg-zinc-900/60 border-b border-zinc-800 text-[9px] font-black uppercase tracking-widest text-zinc-500">
